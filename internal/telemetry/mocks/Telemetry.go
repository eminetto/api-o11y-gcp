...
import (
	...
	telemetry "github.com/eminetto/api-o11y-gcp/internal/telemetry"
...
func (_m *Telemetry) Start(ctx context.Context, name string, opts ...trace.SpanStartOption) (context.Context, telemetry.Span) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, ...trace.SpanStartOption) (context.Context, telemetry.Span)); ok {
